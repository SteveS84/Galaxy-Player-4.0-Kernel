...
typedef struct
{
	...
	SINT16	aswD_Ad1[AD1_VOL_CHANNELS];			// This is not for YMU823
	SINT16	aswD_Aeng6[AENG6_VOL_CHANNELS];
	SINT16	aswD_Pdm[PDM_VOL_CHANNELS];
	SINT16	aswD_Dtmfb[DTMF_VOL_CHANNELS];		// This is not for YMU823
	...
	SINT16	aswD_Ad1Att[AD1_VOL_CHANNELS];		// This is not for YMU823
	...
	SINT16	aswD_DtmfAtt[DTFM_VOL_CHANNELS];		// This is not for YMU823
	...
	SINT16	aswA_Ad1[AD1_VOL_CHANNELS];			// This is not for YMU823
	SINT16	aswA_Lin1[LIN1_VOL_CHANNELS];
	SINT16	aswA_Lin2[LIN2_VOL_CHANNELS];			// This is not for YMU823
