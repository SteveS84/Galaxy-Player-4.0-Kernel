...
//#define	MCDRV_LOGICAL_HPGAIN_DEF	(1536)			/*	6dB	 yosef added for HP gain test	*/ 

#define	MCDRV_VOLUPDATE_ALL_AA			((UINT32)0xFFFFFFFF)
#define	MCDRV_VOLUPDATE_ANAOUT_ALL_AA	((UINT32)0x00000001)
...
)
{
	...
	gsGlobalInfo_AA.sDngInfo.abThreshold[0]	= MCDRV_DNG_THRES_84;
	gsGlobalInfo_AA.sDngInfo.abHold[0]			= MCDRV_DNG_HOLD_500;
	gsGlobalInfo_AA.sDngInfo.abAttack[0]		= 3/*MCDRV_DNG_ATTACK_1100*/;
...
#define	MCDRV_POWUPDATE_DIGITAL_ALL_AA		((UINT32)0xFFFFFFFF)
...
///////////////
#define	MCDRV_MAX_WAIT_TIME_AA	((UINT32)0x0FFFFFFF)
