...
struct gain_info_t playback_gain_table[PLAYBACK_GAIN_NUM] = {
	{ /* COMMON */
		...
		.gain = 0x04 << WM8994_SPKOUTL_BOOST_SHIFT  /* +6dB */
	}, {
		.mode = PLAYBACK_SPK,
		.reg  = WM8994_CLASSD,			/* 25h */
		...
		.mask = WM8994_HPOUT1L_VOL_MASK | WM8994_HPOUT1L_ZC_MASK,
#ifdef CONFIG_MUSIC_CODEC_GAIN
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1L_ZC | DEFAULT_HP_GAIN     /* -16dB */
#else
#ifdef CONFIG_ARIES_KOR
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1L_ZC | 0x36     /* -3dB */
#else
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1L_ZC | 0x35     /* -4dB */
#endif
#endif
	}, {
		.mode = PLAYBACK_HP,
		.reg  = WM8994_RIGHT_OUTPUT_VOLUME,	/* 1Dh */
		.mask = WM8994_HPOUT1R_VOL_MASK | WM8994_HPOUT1R_ZC_MASK,
#ifdef CONFIG_MUSIC_CODEC_GAIN
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1R_ZC | DEFAULT_HP_GAIN	/* -16dB */
#else
#ifdef CONFIG_ARIES_KOR
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1R_ZC | 0x36	/* -3dB */
#else
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1R_ZC | 0x35	/* -4dB */
#endif
#endif
	}, {
		.mode = PLAYBACK_HP,
		...
		.reg  = WM8994_CLASSD,			/* 25h */
		.mask = WM8994_SPKOUTL_BOOST_MASK,
		.gain = 0x4 << WM8994_SPKOUTL_BOOST_SHIFT
	}, {
		.mode = PLAYBACK_SPK_HP,
		.reg  = WM8994_CLASSD,			/* 25h */
		.mask = WM8994_SPKOUTR_BOOST_MASK,
		...
		.reg  = WM8994_LEFT_OUTPUT_VOLUME,	/* 1Ch */
		.mask = WM8994_HPOUT1L_VOL_MASK | WM8994_HPOUT1L_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1L_ZC | 0x16
	}, {
		.mode = PLAYBACK_SPK_HP,
		.reg  = WM8994_RIGHT_OUTPUT_VOLUME,	/* 1Dh */
		.mask = WM8994_HPOUT1R_VOL_MASK | WM8994_HPOUT1R_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1R_ZC | 0x16
	}, {
		.mode = PLAYBACK_SPK_HP,
		.reg  = WM8994_LEFT_OPGA_VOLUME,	/* 20h */
		.mask = WM8994_MIXOUTL_VOL_MASK,
		...
		.reg  = WM8994_LEFT_OUTPUT_VOLUME,	/* 1Ch */
		.mask = WM8994_HPOUT1L_VOL_MASK | WM8994_HPOUT1L_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1L_ZC | 0x34
	}, {
		.mode = PLAYBACK_RING_HP,
		.reg  = WM8994_RIGHT_OUTPUT_VOLUME,	/* 1Dh */
		.mask = WM8994_HPOUT1R_VOL_MASK | WM8994_HPOUT1R_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1R_ZC | 0x34
	}, {
		.mode = PLAYBACK_RING_HP,
		.reg  = WM8994_LEFT_OPGA_VOLUME,	/* 20h */
		.mask = WM8994_MIXOUTL_VOL_MASK,
		...
		.reg  = WM8994_LEFT_OUTPUT_VOLUME,	/* 1Ch */
		.mask = WM8994_HPOUT1L_VOL_MASK | WM8994_HPOUT1L_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1L_ZC | 0x1E
	}, {
		.mode = PLAYBACK_RING_SPK_HP,
		.reg  = WM8994_RIGHT_OUTPUT_VOLUME,	/* 1Dh */
		.mask = WM8994_HPOUT1R_VOL_MASK | WM8994_HPOUT1R_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1R_ZC | 0x1E
	}, { /* HP_NO_MIC */
		...
		.gain = 0x1 << WM8994_AIF1DAC_BOOST_SHIFT
	}, { /* VOIP_SPK */
		...
		.mask = WM8994_SPKOUTL_VOL_MASK,
#ifdef CONFIG_ARIES_KOR
		.gain = WM8994_SPKOUT_VU | 0x37         /* -2dB */
#else
		.gain = WM8994_SPKOUT_VU | 0x3B         /* +2dB */
#endif
	}, {
		.mode = PLAYBACK_VOIP_SPK,
		.reg  = WM8994_SPEAKER_VOLUME_RIGHT,	/* 27h */
		...
		.mask = WM8994_SPKOUTL_BOOST_MASK,
#ifdef CONFIG_ARIES_KOR
		.gain = 0x07 << WM8994_SPKOUTL_BOOST_SHIFT  /* +12dB */
#else
		...
		.reg  = WM8994_CLASSD,			/* 25h */
		.mask = WM8994_SPKOUTR_BOOST_MASK,
		.gain = 0x0 << WM8994_SPKOUTR_BOOST_SHIFT  /* 0dB */
	}, {
		.mode = PLAYBACK_VOIP_SPK,
		.reg  = WM8994_AIF1_CONTROL_2,          /* 301h */
		.mask = WM8994_AIF1DAC_BOOST_MASK,
		...
		.mode = PLAYBACK_VOIP_HP,
		.reg  = WM8994_LEFT_OUTPUT_VOLUME,	/* 1Ch */
		.mask = WM8994_HPOUT1L_VOL_MASK | WM8994_HPOUT1L_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1L_ZC | 0x27     /* -18dB */
	}, {
		.mode = PLAYBACK_VOIP_HP,
		.reg  = WM8994_RIGHT_OUTPUT_VOLUME,	/* 1Dh */
		.mask = WM8994_HPOUT1R_VOL_MASK | WM8994_HPOUT1R_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1R_ZC | 0x27	/* -18dB */
	}, {
		.mode = PLAYBACK_VOIP_HP,
		.reg  = WM8994_LEFT_OPGA_VOLUME,	/* 20h */
		.mask = WM8994_MIXOUTL_VOL_MASK,
...
#else
		.mask = WM8994_HPOUT1L_VOL_MASK | WM8994_HPOUT1L_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1L_ZC | 0x39
#endif
	}, {
		.mode = FMRADIO_HP,
		.reg  = WM8994_RIGHT_OUTPUT_VOLUME,	/* 1Dh */
...
#else
		.mask = WM8994_HPOUT1R_VOL_MASK | WM8994_HPOUT1R_ZC_MASK,
		.gain = WM8994_HPOUT1_VU | WM8994_HPOUT1R_ZC | 0x39
#endif
	}, {
		.mode = FMRADIO_HP,
		.reg  = WM8994_LEFT_OPGA_VOLUME,	/* 20h */
...
void wm8994_disable_rec_path(struct snd_soc_codec *codec)
{
	...
	case MAIN:
		...
		if(!(wm8994->codec_state & CALL_ACTIVE)) {
			...
			/* Disconnect IN1LN and IN1LP to the inputs */
...
void wm8994_record_headset_mic(struct snd_soc_codec *codec)
{
	...
	if(!(wm8994->codec_state & CALL_ACTIVE)) {
		...
		if ((wm8994->input_source == VOIP_INPUT)
#ifdef CONFIG_VOIP
	...
	enum wm8994_dc_servo_slots slots)
{
	...
	val &= ~(0x0005);
        ...
        if((slots == DCS_FMRADIO) || (slots == DCS_FMRADIO_SPK_HP))
                val |= 0x0004;
        else
                val |= 0x0005;
...
void wm8994_set_playback_headset(struct snd_soc_codec *codec)
{
	...
	if (wm8994->output_source == RING_TONE)
        ...
        if(wm8994->music_start_flag && 
                (wm8994->output_source != RING_TONE) &&
                ...
                DEBUG_LOG("set_music_codec_gain(%d)(0x%x)\n",
...
void wm8994_set_playback_speaker(struct snd_soc_codec *codec)
{
	...
	DEBUG_LOG("");
        ...
        wm8994_write(codec, WM8994_AIF1_DAC1_EQ_GAINS_1, 0x01D9);
	...
	/* Speaker Volume Control */
        ...
        if(wm8994->voip_start_flag) {
                /*AIF1DRC1*/
                wm8994_write(codec, WM8994_AIF1_DRC1_1, 0xBC);
                wm8994_write(codec, WM8994_AIF1_DRC1_2, 0x81A);
                wm8994_write(codec, WM8994_AIF1_DRC1_3, 0x848);
                wm8994_write(codec, WM8994_AIF1_DRC1_4, 0x1AD);
                wm8994_write(codec, WM8994_AIF1_DRC1_5, 0x67);
        }
#endif
	...
	val &= ~(WM8994_SPKOUTR_MUTE_N_MASK);
        if(!wm8994->voip_start_flag) {
        	val |= (WM8994_SPKOUTR_MUTE_N);
                ...
                DEBUG_LOG("Voip : Mute right speaker");
        }
	...
	/* Eable DAC1 Left/Right and timeslot left/Right */
	val = wm8994_read(codec, WM8994_POWER_MANAGEMENT_5);
...
void wm8994_set_fmradio_headset(struct snd_soc_codec *codec)
{
	...
	wm8994_write(codec, WM8994_DAC2_RIGHT_VOLUME, val);
        ...
        DEBUG_LOG("set_fm_codec_gain(%d)(0x%x)\n",
...
void wm8994_set_fmradio_speaker(struct snd_soc_codec *codec)
{
	...
	val = wm8994_read(codec, WM8994_POWER_MANAGEMENT_1);
	val &= ~(WM8994_SPKOUTL_ENA_MASK | WM8994_SPKOUTR_ENA_MASK);
	val |= (WM8994_SPKOUTL_ENA | WM8994_SPKOUTR_ENA);
	wm8994_write(codec, WM8994_POWER_MANAGEMENT_1, val);
...
void wm8994_set_fmradio_speaker_headset_mix(struct snd_soc_codec *codec)
{
	...
	val &= ~WM8994_VMID_SEL_MASK;
	val |= (WM8994_BIAS_ENA | WM8994_VMID_SEL_NORMAL | WM8994_HPOUT1R_ENA |
		WM8994_HPOUT1L_ENA | WM8994_SPKOUTL_ENA | WM8994_SPKOUTR_ENA);
	wm8994_write(codec, WM8994_POWER_MANAGEMENT_1, val);
...
int wm8994_set_codec_gain(struct snd_soc_codec *codec, u16 mode, u16 device)
{
	...
	if (mode == PLAYBACK_MODE) {
		...
		case PLAYBACK_VOIP_RCV:
			gain_set_bits |= PLAYBACK_VOIP_RCV;
			break;
		case PLAYBACK_VOIP_SPK:
			gain_set_bits |= PLAYBACK_VOIP_SPK;
			break;
		case PLAYBACK_VOIP_HP:
			gain_set_bits |= PLAYBACK_VOIP_HP;
			break;
		case PLAYBACK_VOIP_BT:
			gain_set_bits |= PLAYBACK_VOIP_BT;
			break;
		default:
