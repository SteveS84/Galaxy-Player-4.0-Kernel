#ifndef __GPIO_VENTURI_REV0_H_
#define __GPIO_VENTURI_REV0_H_
...
// GPD0
#define GPIO_BACKLIGHT_EN		S5PV210_GPD0(0)
#define GPIO_BACKLIGHT_AF		S3C_GPIO_SFN(1)
...
#define GPIO_HDMI_SDA_28V			S5PV210_GPD1(2)
#define GPIO_HDMI_SDA_28V_AF     2
#define GPIO_HDMI_SCL_28V			S5PV210_GPD1(3)
#define GPIO_HDMI_SCL_28V_AF     2
...
#define GPIO_FM_SCL_28V			S5PV210_GPG0(2)
...
#define GPIO_MOVI_RST           S5PV210_GPG1(2)
...
#define GPIO_FM_SDA_28V			S5PV210_GPG2(2)
...
#define GPIO_GPH02				S5PV210_GPH0(2)
...
#define GPIO_GPH13				S5PV210_GPH1(3)

#define GPIO_HDMI_CEC				S5PV210_GPH1(4)
...
// GPH2
#define GPIO_HDMI_EN			S5PV210_GPH2(0)

#define GPIO_TDMB_INT			S5PV210_GPH2(1)
#define GPIO_TDMB_INT_AF        0xF

#define GPIO_LED1_EN			S5PV210_GPH2(2)
#define GPIO_LED1_EN_AF			S3C_GPIO_SFN(1)

#define GPIO_LED2_EN			S5PV210_GPH2(3)
#define GPIO_LED2_EN_AF			S3C_GPIO_SFN(1)
...
#define GPIO_CAM_nSTBY		S5PV210_GPJ0(6)

#define GPIO_HWREV_MODE3		S5PV210_GPJ0(7)

// GPJ1
#define GPIO_GPJ10				S5PV210_GPJ1(0)

#define GPIO_VIBTONE_EN1		S5PV210_GPJ1(1)

#define GPIO_MUTE_ON			S5PV210_GPJ1(2)
...
// GPJ2
#define GPIO_TA_CURRENT_SEL		S5PV210_GPJ2(0)

#define GPIO_GPJ21				S5PV210_GPJ2(1)

#define GPIO_BT_WAKE			S5PV210_GPJ2(2)
...
//#define GPIO_CAM_VGA_nSTBY_SEL		S5PV210_GPJ2(6)
#define GPIO_CAM_VGA_nSTBY		S5PV210_GPJ2(6)

#define GPIO_CAM_VGA_nRST		S5PV210_GPJ2(7)

// GPJ3
#define GPIO_GPJ30				S5PV210_GPJ3(0)

#define GPIO_GPJ31				S5PV210_GPJ3(1)

#define GPIO_GPJ32				S5PV210_GPJ3(2)
...
#define GPIO_MP013				S5PV210_MP01(3)
...
#define GPIO_MP022			S5PV210_MP02(2)
...
#define GPIO_CAM_FLASH_EN_SET	S5PV210_MP04(2)	// FLASH_EN1

#define GPIO_DISPLAY_SI			S5PV210_MP04(3)
#define GPIO_DISPLAY_SI_AF		S3C_GPIO_SFN(1)

#define GPIO_CAM_FLASH_EN		S5PV210_MP04(4) // FLASH_EN2
...
// MP05
#define GPIO_MP050				S5PV210_MP05(0)

#define GPIO_MP051				S5PV210_MP05(1)
...
#define GPIO_CAM_MEGA_EN		__NC__
#define GPIO_USB_SEL			__NC__
#define GPIO_WLAN_WAKE			__NC__	
#define GPIO_WLAN_WAKE_AF		__NC__	
#define _3_GPIO_TOUCH_CE	    __NC__
#endif
/* end of __GPIO_VENTURI_REV0_H_ */
